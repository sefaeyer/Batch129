package advanced_practice.advanced_practice11.interface_maas_hesapla;
...
public class InterfaceRunner {
    ...
    public static void main(String[] args) {
       ...
       System.out.println(maasHesapla.netMaas(10000, 11, 160));

       MaasHesapla maasHesapl = new MaasHesapla();
        System.out.println(maasHesapl.netMaas(7000, 5, 210));
